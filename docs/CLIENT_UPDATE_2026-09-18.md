...
- $100.00 charged live, the weekly mandate is bound to his card, week 1 is paid. **The renewal charge fires 24 Sep**, covering the week from 25 Sep.
...
> **The full weekly recurring rental works, has been run end to end from a phone, and is now running with REAL money — Fenix's rental started today and the first automatic renewal charge fires 24 Sep.**
...
- **Fenix's recurring rental, today:** **$100.00 charged → $10.00 platform fee (10%) → $90.00 accruing to George.** Mandate bound to his Visa; week 1 paid; the renewal charge fires **24 Sep** (the reminder lands 23 Sep), covering the week from 25 Sep.
...
- **Next real milestone: the automatic renewal charge on 24 Sep** — the first charge that happens with nobody watching. The driver is reminded 23 Sep; the new week runs from 25 Sep.
...
- **Watch the 24 Sep renewal together?** It is the first charge nobody is watching. Worth agreeing now who checks it and what happens if it declines.
...
- **Open:** "The first real-money recurring rental is running right now — Fenix, on your CR-V, since this morning. $100 charged, your $90 accruing, renews automatically — the card is charged on the 24th for the week starting the 25th."
...
- **The ask:** sign a monthly package if he wants monthly; agree who watches the 24 Sep renewal charge.
