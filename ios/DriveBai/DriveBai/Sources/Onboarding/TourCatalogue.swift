        ...
        case .driverTabs:
            return [
                ...
                TourStep(id: "chats", tour: tour,
                         ...
                         primaryTitle: "Next"),
                // Before "profile" so the terminal CTA stays on the last step.
                TourStep(id: "support", tour: tour,
                         title: "DriveBai support",
                         body: "This button reaches our team from any tab — report a problem, track your requests, or just chat.",
                         target: .supportButton, arrow: .down, cardPlacement: .above,
                         primaryTitle: "Next"),
